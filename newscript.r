...
pred5 <- metaLoadData("pred5m_fit","pred5m_nov50","pred5m_nov50_indshare","pred5m_nov50_indmult", params=par, names=c("fit","nov-group","nov-indshare","nov-indmult"))
fullStatistics(pred5, expset.name="p5", fit.comp=T, fit.comp.par=list(snapshots=c(100,250,499)), fit.ind=T, som.group=T, som.alljobs=T, som.ind=T, behav.mean=T, show.only=F)
...
ke <- metaLoadData("k3_ph_med_fit","k3_ph_med_nov50","k3_ph_med_nov50_indshare","k3_ph_med_nov50_indmult", params=par, names=c("fit","nov-group","nov-indshare","nov-indmult"))
fullStatistics(ke, expset.name="ke", fit.comp=T, fit.comp.par=list(snapshots=c(333,666,999)), fit.ind=T, som.group=T, som.alljobs=T, som.ind=T, behav.mean=T, show.only=F)
kh <- metaLoadData("k3_ph_hard_fit","k3_ph_hard_nov50","k3_ph_hard_nov50_indshare","k3_ph_hard_nov50_indmult", params=par, names=c("fit","nov-group","nov-indshare","nov-indmult"))
fullStatistics(kh, expset.name="kh", fit.comp=T, fit.comp.par=list(snapshots=c(333,666,999)), fit.ind=T, som.group=T, som.alljobs=T, som.ind=T, behav.mean=T, show.only=F)
