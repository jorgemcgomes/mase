...
./evolve.sh -out /home/jorge/exps/bench/single_ns_neat -file build/classes/mase/app/pred/benchmark.params -file build/classes/mase/novelty/novelty.params -file build/classes/mase/neat/neat.params -p pop.subpops=1 -force

./evolve.sh -out /home/jorge/exps/bench/single_nsmo_neat -file build/classes/mase/app/pred/benchmark.params -file build/classes/mase/novelty/comb/nsga_scores.params -file build/classes/mase/neat/neat.params -p pop.subpops=1 -force

./evolve.sh -out /home/jorge/exps/bench/ccea_fitness_neat -file build/classes/mase/app/pred/benchmark.params -file build/classes/mase/cooperative.params -file build/classes/mase/neat/neat.params -p pop.subpops=3 -force

./evolve.sh -out /home/jorge/exps/bench/ccea_ns_neat -file build/classes/mase/app/pred/benchmark.params -file build/classes/mase/cooperative.params -file build/classes/mase/novelty/novelty.params -file build/classes/mase/neat/neat.params -p pop.subpops=3 -force

./evolve.sh -out /home/jorge/exps/bench/ccea_nsmo_neat -file build/classes/mase/app/pred/benchmark.params -file build/classes/mase/cooperative.params -file build/classes/mase/novelty/comb/nsga_scores.params -file build/classes/mase/neat/neat.params -p pop.subpops=3 -force

./evolve.sh -out /home/jorge/exps/bench/hyb_fitness_neat -file build/classes/mase/app/pred/benchmark.params -file build/classes/mase/spec/hybrid.params -file build/classes/mase/neat/neat.params -p pop.subpops=3 -p exch.behaviour-index=2 -force
