...
runCommandLine("-out pred3_nov50_indshare -p parent.0=src/mase/app/pred/oneprey.params -p parent.1=src/mase/novelty/linearscal.params -p parent.2=src/mase/coevolution.params -p pop.subpops=3 -p jobs=10 -p generations=500 -p eval.post.1.ns-blend=0.5 -p eval.post.0.ns-archive-mode=shared -p fitness.novelty-index=2")
runCommandLine("-out pred3_nov50_indmult -p parent.0=src/mase/app/pred/oneprey.params -p parent.1=src/mase/novelty/linearscal.params -p parent.2=src/mase/coevolution.params -p pop.subpops=3 -p jobs=10 -p generations=500 -p eval.post.1.ns-blend=0.5 -p eval.post.0.ns-archive-mode=multiple -p fitness.novelty-index=2")
