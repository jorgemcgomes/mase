        ...
        for (int job = 0; job < tars[0].size(); job++) {
            ...
            for(int g = 0 ; g < subpopEvals[0].size() ; g++) {
                ...
                for(int s = 0 ; s < 2 ; s++) {
                    ...
                    BehaviourResult br  = (BehaviourResult) ((SubpopEvaluationResult) er[1]).getSubpopEvaluation(s);
                    BehaviourResult obr = (BehaviourResult) ((SubpopEvaluationResult) solutions[s].get(g).getEvalResults()[1]).getSubpopEvaluation(0);
