...
public class GoFitness extends MasonEvaluation {
    ...
    protected void postSimulation(MasonSimState sim) {
        ...
        res = new CompoundEvaluationResult(
                new FitnessResult(100f + blackScore - whiteScore, FitnessResult.MergeMode.arithmetic),  
                new FitnessResult(100f + whiteScore - blackScore, FitnessResult.MergeMode.arithmetic));
    }
