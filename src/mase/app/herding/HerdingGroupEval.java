...
public class HerdingGroupEval extends MasonEvaluation {
    ...
    protected void preSimulation(MasonSimState sim) {
        ...
        initSheepCurral =  herd.curral.getPolygon().closestDistance(herd.sheeps.get(0).getLocation());
        initSheepFox = 0;
    ...
    protected void evaluate(MasonSimState sim) {
        ...
        sheepFence += herd.fence.getPolygon().closestDistance(s.getLocation());
        for (Fox f : herd.foxes) {
    ...
    protected void postSimulation(MasonSimState sim) {
        ...
        Herding herd = (Herding) sim;
        Sheep s = herd.sheeps.get(0);
        double sheepCurral = herd.curral.getPolygon().closestDistance(s.getLocation());
